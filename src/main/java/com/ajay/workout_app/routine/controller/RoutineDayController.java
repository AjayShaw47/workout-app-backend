...
public class RoutineDayController {
    ...
    public ResponseEntity<RoutineDayResponse> getRoutine(
            @PathVariable Integer dayOfWeek, // make it short later
        ...
        return ResponseEntity.ok(routineDayService.getDayRoutine(userId, dayOfWeek));
    }

    @PostMapping("/{dayOfWeek}")
    public ResponseEntity<RoutineDayResponse> createRoutine(
            @PathVariable Short dayOfWeek,
            @Valid @RequestBody RoutineDayRequest request) {
